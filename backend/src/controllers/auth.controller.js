    ...
    try {
        ...
        if (validatedData.kycDocument) {
            ...
            try {
                ...
                const uploadResult = await cloudinary_1.default.uploader.upload(validatedData.kycDocument, {
    ...
    try {
        ...
        if (kyc) {
            ...
            if (kyc.aadhaarFront && mimeRegex.test(kyc.aadhaarFront)) {
                ...
                const uploadResult = await cloudinary_1.default.uploader.upload(kyc.aadhaarFront, {
                    folder: 'kyc_documents',
                    resource_type: 'auto'
                });
            ...
            if (kyc.aadhaarBack && mimeRegex.test(kyc.aadhaarBack)) {
                ...
                const uploadResult = await cloudinary_1.default.uploader.upload(kyc.aadhaarBack, {
                    folder: 'kyc_documents',
                    resource_type: 'auto'
                });
